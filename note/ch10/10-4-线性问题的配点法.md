...
> **Demo:** **A finite-difference collocation solver for linear BVPs**. We implement a solver that uses second-order finite differences (from **10-3-微分矩阵**) and enforces Dirichlet boundary conditions by replacing the first and last rows of the collocation system.
>
> ```Python
> import numpy as np
>
