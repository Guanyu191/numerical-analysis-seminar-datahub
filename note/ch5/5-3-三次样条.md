...
> Let $f\in C^4[a,b]$, and let $S_n$ be the not-a-knot cubic spline interpolant of the data $(t_i,f(t_i))$, $i=0,\ldots,n$, on the equally spaced nodes $t_i=a+ih$, where $h=(b-a)/n$.
