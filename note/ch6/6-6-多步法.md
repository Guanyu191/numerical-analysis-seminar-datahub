...
>
> **Example:** **AB2**. AB2 is $u_{i+1}=u_i+h\left(\frac{3}{2}f_i-\frac{1}{2}f_{i-1}\right)$, with $\rho(z)=z^2-z$ and $\sigma(z)=\frac{1}{2}(3z-1)$. A Taylor expansion shows $\tau_{i+1}(h)=O(h^2)$, hence AB2 is second order.
