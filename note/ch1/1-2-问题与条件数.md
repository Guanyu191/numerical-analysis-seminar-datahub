...
> **Example:**
> Let's return to our "add 1" problem and generalize it slightly to $f(x)=x-c$ for
...
> **Example:**
> Another elementary operation is to multiply by a constant: $f(x)=cx$ for nonzero $c$.
> We compute
> $$
